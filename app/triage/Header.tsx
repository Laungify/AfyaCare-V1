      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Triage Department</p>
              </div>
            </Link>
          </div>
          ...
          <nav className="flex items-center space-x-6">
            ...
            <Link href="/triage" className="text-blue-600 font-medium">
              Triage
            </Link>
          ...
          <div className="flex items-center space-x-4">
            <div className="text-right">
              <p className="text-sm font-medium text-gray-900">Nurse Jane Wanjiru</p>
              <p className="text-xs text-gray-600">Triage Nurse</p>
            </div>
